    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('acp/dashboard')}}">Admin Toeic</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="{{url('acp/logout')}}"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{url('acp/dashboard')}}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="{{url('acp/question_packages')}}"><i class="fa fa-bar-chart-o fa-fw"></i> Gói câu hỏi</a>
                        
                        </li>
                        <li>
                            <a href="{{url('acp/question_types')}}"><i class="fa fa-cube fa-fw"></i> Loại câu hỏi</a>
                            
                        </li>
                        <li>
                            <a href="{{url('acp/questions')}}"><i class="fa fa-cube fa-fw"></i> Câu hỏi</a>
                           
                        </li>
                        <li>
                            <a href="{{url('acp/users')}}"><i class="fa fa-users fa-fw"></i> User</a>
                           
                        </li>
                        <li>
                            <a href="{{url('acp/logout')}}"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
